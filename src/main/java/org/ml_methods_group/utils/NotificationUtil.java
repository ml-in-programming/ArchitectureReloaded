...
public final class NotificationUtil {
    ...
    public static void notifyInfo(@NotNull Project project, @NotNull String title, @NotNull String message) {
        notify(project, title, message, NOTIFICATION_GROUP_ID, NotificationType.INFORMATION);
    }

    private static void notify(@NotNull Project project,
                               @NotNull String title,
                               @NotNull String message,
                               @NotNull String groupId,
                               @NotNull NotificationType type) {
        Notifications.Bus.notify(new Notification(groupId, title, message, type), project);
    }
}
