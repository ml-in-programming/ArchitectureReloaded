...
public abstract class MoveToClassRefactoring {
    ...
    public @NotNull PsiClass getTargetClassOrThrow() {
        return getTargetClass().orElseThrow(() -> new IllegalStateException("Cannot get target class. Reference is invalid."));
    }

    public @NotNull PsiMember getEntityOrThrow() {
        return getEntity().orElseThrow(() -> new IllegalStateException("Cannot get entity. Reference is invalid."));
    }
