...
public class QMoveTest extends LightCodeInsightFixtureTestCase {
...
//    }
    ...
    public void testMoveMethod() throws IOException {
        ...
        profile = MetricsProfilesUtil.createProfile("test_profile", QMoveClassEntity.getRequestedMetrics());
        MetricsRunImpl metricsRun = new MetricsRunImpl();
        metricsRun.setProfileName(profile.getName());
        metricsRun.setContext(analysisScope);

        searchResult = QMoveEntitySearcher.analyze(analysisScope, metricsRun);
    }
