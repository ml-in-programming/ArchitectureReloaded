...
import com.sixrr.stockmetrics.classMetrics.NumProtectedFieldsMetric;

public class NumProtectedFieldsMetricTest extends MetricAbstractTest {
    private final static Metric METRIC = new NumProtectedFieldsMetric();
